...
# PART 2 - Web crawler with graph implemented --------------------------------------------
...
# PART 4 - Implementation of ranks computation -------------------------------------------
...
def compute_ranks(graph):
    ...
    for i in range(0, numloops):
        ...
        for page in graph:
            newrank = (1 - d) / npages
            # update by summing in the linking ranks
            for node in graph:
...
# PART 5 - Lookup best result ------------------------------------------------------------

def lookup_best(ranks,index,keyword):
    maxrank = 0
    if keyword in index:
        for p in index[keyword]:
            if ranks[p] > maxrank:
                maxrank = ranks[p]
                best = p
        return best
...
index, graph = crawl_web('http://udacity.com/cs101x/urank/index.html')
ranks = compute_ranks(graph)
url = lookup_best(ranks, index, 'Hummus')
print url
#print index
